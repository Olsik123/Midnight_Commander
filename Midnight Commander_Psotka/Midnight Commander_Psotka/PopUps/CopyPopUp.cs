...
namespace Midnight_Commander_Psotka.PopUps
{
    public class CopyPopUp : PopUp
    {
        ...
        public CopyPopUp(string path, string userMade)
        {
            Marked = 1;
            FirstPath = path;
        ...
        public void CopyCopy(DirectoryInfo d, string name)
        {
