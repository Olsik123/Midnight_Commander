...
{
    public class MoveFilePopUp : PopUp
    {
        ...
        public MoveFilePopUp(string path, string userMade)
        {
            Marked = 1;
            FirstPath = path;
            UserMadeName = userMade;
            string[] SplittedPath = path.ToString().Split(@"\");
            string LastFolder = UserMadeName + @"\" + SplittedPath[SplittedPath.Length - 1];
            UserMadeName = LastFolder;
        }
        public override void Draw()
        {
            ...
            Console.Write(" │ "+"The file you want to move:".PadRight(95)+ "│ ");  
